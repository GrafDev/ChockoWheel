...
export class ImagePreloader {
  ...
  getImageList(region = 'eu') {
    ...
    return [
      ...
      './images/bg-part1.png',
      './images/arrow.png',
      './images/sound-button.png',
      './images/hand-pointer.png',
      './images/spin-button.png',
      './images/wheel-light.png',
      './images/wheel-border.png',
      './images/wheel-center.png',
      './images/wheel-sectors.png',
      './images/logo1-part1.png',
      './images/logo1-part2.png',
      './images/logo1-part3.png',
      './images/logo2-part1.png',
      './images/logo2-part2.png',
      './images/chicken-part1.png',
